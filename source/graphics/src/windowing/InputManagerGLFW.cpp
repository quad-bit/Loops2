...
namespace
{
    ...
    static void MouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
    {
        ...
        Renderer::Windowing::MouseInputManager::GetInstance()->MouseButtonEventHandler(get_button_name(button), get_action_name(action));
    }
    ...
    static void CursorPositionCallback(GLFWwindow* window, double x, double y)
    {
        ...
        Renderer::Windowing::MouseInputManager::GetInstance()->MousePointerEventHandler(x, y);
    }
    ...
    static void key_callback(GLFWwindow* window, int key, int scancode, int action, int mods)
    {
        ...
        Renderer::Windowing::KeyInputEvent* keyEvent = Renderer::Windowing::InputManager::GetInstance()->FetchKeyInputEvent();
        ...
        {
            keyEvent->keyState = Renderer::Windowing::KeyState::DOWN;
        }
        ...
        Renderer::Windowing::InputManager::GetInstance()->EventNotification(keyEvent);
...
void Renderer::Windowing::InputManager::DeInit()
{
    PLOGD << "Input manager DeInit";
}

void Renderer::Windowing::InputManager::Update()
{
}
