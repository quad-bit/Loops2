...
void Renderer::CommandReader::Dispatch(const Core::Wrappers::CommandBufferInfo& cmdBufInfo, uint32_t groupX, uint32_t groupY, uint32_t groupZ)
{
    GfxVk::CommandWriter::Dispatch(cmdBufInfo, groupX, groupY, groupZ);
}
